...
export const biologicalMaterialScienceAndEngineering: QuizData[] = [
  ...
  /** 29回(PM) */
  {
    question: '生体の電気特性について誤っているのはどれか。',
    options: [
      '低周波では誘電率が大きい',
      '骨格筋は異方性が大きい',
      '細胞膜は大きな電気容量をもつ',
  ...
  },
  {
    ...
    options: [
      ...
      '生体軟組織のポアソン比はおよそ0.5である',
      '生体軟組織の体積弾性率はヤング率よりも小さい',
  ...
  /** 30回(PM) */
  {
    question: '生体組織中に照射された超音波について正しいのはどれか。',
    options: [
  ...
  /** 31回(AM) */
  {
    question: '興奮性細胞の電気的特性で誤っている組合せはどれか。',
    options: [
      '再分極相 -------- 不応期',
      '細胞膜 -------- 静電容量',
      '静止電位 -------- -90~-50mV',
  ...
  /** 32回(AM) */
  {
    question: '生体の電気特性について誤っている組合せはどれか。',
    options: [
      'α分散 -------- イオンの移動',
      'β分散 -------- 水分子の緩和現象',
      '能動性 -------- 細胞の電気的興奮',
  ...
  /** 34回(PM) */
  {
    question: '神経細胞の興奮について誤っている組合せはどれか。',
    options: [
      '跳躍伝導 -------- 有髄神経の興奮伝搬',
      '静止電位 -------- 細胞内外のイオン濃度差',
      '脱分極 -------- Naイオンの細胞内流入',
  ...
  /** 36回(AM) */
  {
    question: '100Hzにおける生体組織の導電率の大小関係で正しいのはどれか。',
    options: [
      '脂肪<血液<骨格筋',
      '脂肪<骨格筋<血液',
      '骨格筋<血液<肝臓',
